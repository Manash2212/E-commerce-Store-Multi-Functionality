...
const SecondSlider = ({
  ...
  return (
    <div className="slider w-full h-[85vh]">
      <div className="container overflow-hidden flex mx-auto  max-w-[90vw]  h-full relative ">
        <div
        ...
        {/* In here i'm not using Arrow Click */}
          ...
          {slides.map((img, i) => (
            <div
              ...
              className={`transition-all rounded-full w-1.5 h-1 ${
                i === currentSlide ? "bg-black scale-125" : "bg-gray-400"
              } cursor-pointer`}
            ></div>
          ))}
        </div>
